...
export default function MovieHide(props) {
  ...
  movies.forEach(function (movie, index) {
    if (movie.release_date.length > 0) {
      if (mappingDate[movie.release_date.substr(0, 3)] > 4) {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Form, null, /*#__PURE__*/React.createElement(Row, {
  ...
  }, /*#__PURE__*/React.createElement("h2", null, "Retrieve Movies: "), /*#__PURE__*/React.createElement("h3", null, "With every retrieval, please reset list for next search")), /*#__PURE__*/React.createElement(Form.Group, {
    as: Col
    ...
    variant: "primary",
    onClick: () => {
      props.onRetrieve(filteredLevel3);
    }
  }, "Retrieve")))));
}
;
